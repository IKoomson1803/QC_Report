...
Dim sJobNum, sQCNum, sRev, sFrm, sItemNum, sClient,sQC_Type
...
sqlClient = "Select CustID,QC_Type From qcHeader WHERE qcnum = " & CLng(sQCNum) & " AND subQCNum = " & CInt(sRev)
rsClient.ActiveConnection = cnQCS
rsClient.Open sqlClient
sClient = rsClient.Fields("CustID")
sQC_Type = rsClient.Fields("QC_Type")
rsClient.Close
...
''Response.Write "sQCType: " & sQC_Type
...
id=TimeCodeControl1 
style="LEFT: 0px; TOP: 0px" 
classid="clsid:6E0D2CE3-D67D-11D4-8ECD-00805F0FA4D0"
codebase="../qc/New_Source/sonytimecontrol/sonytimecontrol.ocx" 
VIEWASTEXT>
	<PARAM NAME="_ExtentX" VALUE="5927">
	<PARAM NAME="_ExtentY" VALUE="1085">
	<PARAM NAME="vBackColor" VALUE="-2147483633">
