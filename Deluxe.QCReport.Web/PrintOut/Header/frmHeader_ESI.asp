...
'*******************************************************************************************************
		sql="SELECT Pono, This_part, Tot_Part, QC_date, " & _
				...
				"Subtitle, HLanguage, Status, HeadLogo, TailLogo, AssetType, Filename " & _
			"FROM qcHeader " & _
			...
			"GROUP BY Pono, This_part, Tot_Part, Epis_no, " & _
				...
				"Version, TapeDesc1, Format, Standard, TRT, TapeNumber, " & _
				"Subtitle, HLanguage, Status, HeadLogo, TailLogo, Qcnum, subQcnum, AssetType, Filename " & _
...
<!--#include file="../include/frmToolBar.asp"-->
		<form method="post" name="frmHeader" action="procHeader_ESI.asp">
		...
		<input type="hidden" id="selCustName" name="selCustName" value="<%=rsFrm.Fields("CustName")%>">
			<tr>
				...
				<td><INPUT size=5 type="text" id=txtThis_Part name=txtThis_Part value="<%=rsFrm.Fields("This_Part")%>" > of <INPUT size=5 type="text" id=txtTot_Part name=txtTot_Part value=<%=rsFrm.Fields("Tot_Part")%>></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<select id=selStandard name=selStandard>
						...
						<option>1080/29.97P</option>
						<option>1080/25P</option>
						<option>1080/24P</option>
						<option>1080/23.98P</option>
						
						<option>2K/59.94i</option>
						<option>2K/50i</option>
						<option>2K/29.97P</option>
						<option>2K/25P</option>
						<option>2K/24P</option>
						<option>2K/23.98P</option>
						<option>UHD/59.94i</option>
						<option>UHD/50i</option>
						<option>UHD/29.97P</option>
						<option>UHD/25P</option>
						<option>UHD/24P</option>
						<option>UHD/23.98P</option>
					    <option>4K/59.94i</option>
						<option>4K/50i</option>
						<option>4K/29.97P</option>
						<option>4K/25P</option>
						<option>4K/24P</option>
						<option>4K/23.98P</option>
					</select>&nbsp;&nbsp;
				</td>
