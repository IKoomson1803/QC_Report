...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
	<tr>
	  <td class="blacksquare" style="padding:2px" align="center" colspan="5">
	    <b>AUDIO LAYOUT</b>
	  </td>
	<tr>
	<!--<tr>
	...
	<tr>
		  <td colspan="5" height="100%"  >
				 <table width="100%" border="0" cellspacing="0" cellpadding="0" >
					   <tr>
						 <td  <% If bIsTwoChannels = True And bIsFourChannels = False  Then %> width="100%" <%Else %> width="50%" <%End If%> class="blacksquare" height="100%" valign="top"  >
						   <table width="100%" border="0" cellspacing="0" cellpadding="2" height="100%" >
							    <tr>
									...
									<td height="17px" width="9%" class="bottom_border"><b>Discrete</b></td>
						 ...
						 <td <% If bIsTwoChannels = True And bIsFourChannels = False  Then %> style="display:none;" <%Else %> width="50%" class="right_top_bottom_border" height="100%" valign="top" height="100%"  <%End If%>     >
					      <table width="100%" border="0" cellspacing="0" cellpadding="2" height="100%" >
							     <tr>
									<td height="17px" width="6%"  class="bottom_border">&nbsp;</td>
									<td height="17px" width="9%" class="bottom_border"><b>Track</b></td>
