...
<%
option explicit
dim rsHeader, rsChecklist
dim sBVMaster, sBVTech1, sBVTech2, sBVTech4, sCTISS, sQCR, sQCR100, sQCR1Pg, rsTextInfo, sqlTextInfo, sqlChecklist
dim sQCNum, sRev, sqlBVIMaster, rsFullSpot, sqlFullSpot, siremv
dim sWBQCR, sMQCR, sQCWLR1Pg, sQCWTR1Pg, sQCRWLE  
dim sAssetType
...
response.write "sQCNum:" & sQCNum 
response.write " sRev:" & sRev  
...
sqlBVIMaster = "SELECT " & _
					...
					"Broadcast_Suitable,Broadcast_Suitable_Reason,DVD_Blu_Ray_Suitable,DVD_Blu_Ray_Suitable_Reason,VOD_Suitable,VOD_Suitable_Reason, CatalogueID " & _ 
				"FROM qcHeader " & _
...
''Response.Write "sAssetType:" &  sAssetType
...
sqlChecklist = "SELECT TOP 1 [ChecklistId] " & _
      ", [QCNum]" & _
      ",[subQCNum]" & _
      ",[CustId]" & _
      ",[Audio24TracksPresent]" & _
      ",[AudioTrackLayout]" & _
      ",[AudioCodec]" & _
      ",[AudioSampleRate]" & _
      ",[AudioBitRate]" & _
      ",[AudioBitDepth]" & _
      ",[AudioChannelsDiscrete]" & _
      ",[AudioTracksLabelledOrtTaggedInQT]" & _
      ",[IsFile]" & _
      ",[FileType]" & _
      ",[FileName]" & _
      ",[ProgrammeHeadBuild]" & _
      ",[ProgrammeSlatePresent]" & _
      ",[ProgrammeStart1stBlackVideoAndAudio]" & _
      ",[ProgrammeBlackBetweenProgrammeAndTextlessElements]" & _
      ",[ProgrammeTextlessElementsPresent]" & _
      ",[ProgrammeFullTextlessCoversForTextedShotsPresent]" & _
      ",[ProgrammeDoesTextlessMatchTheFramingAndAspectRatioOfItsCorrespondingTextedShot]" & _
      ",[ProgrammeTextlessGaps1Or2s]" & _
      ",[ProgrammeEnd1stBlackVideoAndAudio]" & _
      ",[VideoJesExtensifier]" & _
      ",[VideoContainerOrWrapper]" & _
      ",[VideoTimecode]" & _
      ",[VideoCodec]" & _
      ",[VideoResolution]" & _
      ",[VideoFrameRateOrStandard]" & _
      ",[VideoDisplayAspectRatio]" & _
      ",[VideoProgressive]" & _
      ",[VideoCLAP]" & _
      ",[VideoColourPrimaries]" & _
      ",[VideoTransferCharacteristics]" & _
      ",[VideoMatrixCoefficients]" & _
      ",[ChecklistCompleted]" & _
  " FROM [QCSUK].[bward].[Checklist]"  & _
   " WHERE Qcnum= " & cint(sQCNum) & " AND subQcnum = " & cint(sRev)
  
  
  rsChecklist.Open sqlChecklist
