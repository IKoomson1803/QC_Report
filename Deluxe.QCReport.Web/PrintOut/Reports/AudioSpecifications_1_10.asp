           ...
           <% If Not IsNull(rsHeader.Fields("Ch1_Desc").value) And Trim(rsHeader.Fields("Ch1_Desc").value) <> ""  Then %>
			 ...
			 <%
			  ...
			  <% If Not IsNull(rsHeader.Fields("Ch5_Desc").value) And Trim(rsHeader.Fields("Ch5_Desc").value) <> ""  Then %>
               <tr>
                <td width="6%" class="right_border"><b>&nbsp;Ch5&nbsp;</b></td>
                <td width="18%">&nbsp;<%=rsHeader.Fields("Ch5_Desc")%>&nbsp;</td>
				<td width="12%"><%=rsHeader.Fields("Language5")%>&nbsp;</td>
				
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"InPhase5")%>&nbsp;</td>
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"Discreate5")%>&nbsp;</td>
				
				
                <td width="12%"><%=rsHeader.Fields("Ch5_LKFS")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch5_Tone")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch5_Avg")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch5_Peak")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("CH5_TruePeak")%>&nbsp;</td>
				<td width="12%">
				 <%
              ...
              <tr>
                <td width="6%" class="right_border"><b>&nbsp;Ch6&nbsp;</b></td>
                <td width="18%">&nbsp;<%=rsHeader.Fields("Ch6_Desc")%>&nbsp;</td>
				<td width="12%"><%=rsHeader.Fields("Language6")%>&nbsp;</td>
				
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"InPhase6")%>&nbsp;</td>
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"Discreate6")%>&nbsp;</td>
				
                <td width="12%"><%=rsHeader.Fields("Ch6_LKFS")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch6_Tone")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch6_Avg")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch6_Peak")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("CH6_TruePeak")%>&nbsp;</td>
				<td width="12%">
				 <%
              ...
              <tr>
                <td width="6%" class="right_border"><b>&nbsp;Ch7&nbsp;</b></td>
                <td width="18%">&nbsp;<%=rsHeader.Fields("Ch7_Desc")%>&nbsp;</td>
				<td width="12%"><%=rsHeader.Fields("Language7")%>&nbsp;</td>
				
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"InPhase7")%>&nbsp;</td>
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"Discreate7")%>&nbsp;</td>
				
                <td width="12%"><%=rsHeader.Fields("Ch7_LKFS")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch7_Tone")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch7_Avg")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch7_Peak")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("CH7_TruePeak")%>&nbsp;</td>
				<td width="12%">
			 <%
              ...
              <tr>
                <td width="6%" class="right_border"><b>&nbsp;Ch8&nbsp;</b></td>
                <td width="18%">&nbsp;<%=rsHeader.Fields("Ch8_Desc")%>&nbsp;</td>
				<td width="12%"><%=rsHeader.Fields("Language8")%>&nbsp;</td>
				
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"InPhase8")%>&nbsp;</td>
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"Discreate8")%>&nbsp;</td>
				
                <td width="12%"><%=rsHeader.Fields("Ch8_LKFS")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch8_Tone")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch8_Avg")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch8_Peak")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("CH8_TruePeak")%>&nbsp;</td>
				<td width="12%">
				 <%
              ...
              <tr>
                <td width="6%" class="right_border"><b>&nbsp;Ch9&nbsp;</b></td>
                <td width="18%">&nbsp;<%=rsHeader.Fields("Ch9_Desc")%>&nbsp;</td>
				<td width="12%"><%=rsHeader.Fields("Language9")%>&nbsp;</td>
				
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"InPhase9")%>&nbsp;</td>
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"Discreate9")%>&nbsp;</td>
				
                <td width="12%"><%=rsHeader.Fields("Ch9_LKFS")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch9_Tone")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch9_Avg")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch9_Peak")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("CH9_TruePeak")%>&nbsp;</td>
				<td width="12%">
				 <%
             ...
             <% End If %>
              ...
              <tr>
                <td width="6%" class="right_border"><b>&nbsp;Ch10&nbsp;</b></td>
                <td width="18%">&nbsp;<%=rsHeader.Fields("Ch10_Desc")%>&nbsp;</td>
				<td width="12%"><%=rsHeader.Fields("Language10")%>&nbsp;</td>
				
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"InPhase10")%>&nbsp;</td>
				<td width="9%">&nbsp;<%=FieldExists(rsHeader,"Discreate10")%>&nbsp;</td>
				
                <td width="12%"><%=rsHeader.Fields("Ch10_LKFS")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch10_Tone")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch10_Avg")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("Ch10_Peak")%>&nbsp;</td>
                <td width="12%"><%=rsHeader.Fields("CH10_TruePeak")%>&nbsp;</td>
				<td width="12%">
				 <%
