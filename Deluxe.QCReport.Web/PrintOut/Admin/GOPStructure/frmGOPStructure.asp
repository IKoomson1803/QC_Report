...
'********************
dim rsFrm, rsCombo
dim sVideoDescID, sGOPStructure
dim sql
...
'*******************************************************************************************************
		sql="SELECT GOPStructureID,GOPStructure FROM optGOPStructure ORDER BY GOPStructure"
'*******************************************************************************************************
...
<table id="tblForm" width=100%>
	<tr>
		<td>
			...
			<form method="post" name="frmGOPStructure" action="procInsertGOPStructure.asp">
				<tr>
					<td>
						GOP Structure:</td>
					<td>				
						<input type="text" id="txtGOPStructure" name="txtGOPStructure" size="50">
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td align="Center" colspan="6">
						<input type="submit" name="subUpdate" value="Add GOPStructure" ></td>
				</tr>
				</form>
			</table>
		</td>
		<td>
			<table align=center id="tblTapeFormat" border=0 width=200 cellpadding=0 cellspacing=0>
						<tr bgcolor=#999900>
							<td align="center">GOP Structure</td>
						</tr>
				<%sBGColor = "trBeige"%>
				...
				<%		do while not rsFrm.EOF %>
							<tr class=<%=sBGColor%> onmouseover="this.className='trWhite'" onmouseout="this.className='<%=sBGColor%>'" onclick="javascript:OpenEditFrm('frmUpdateGOPStructure.asp?GOPStructureID=<%=rsFrm.Fields("GOPStructureID")%>');">
								<td align="center"><%=rsFrm.Fields("GOPStructure")%></td>
							</tr>
				<%			rsFrm.MoveNext
