...
<script Language="javascript">
	...
	{ 
        ...
        var isNumeric = ( (inputValue - 0) == inputValue && inputValue.length > 0 );
		 ...
		 {
		   frmAudioBitDepth.action = 'procInsertAudioBitDepth.asp';
		   frmAudioBitDepth.submit();
		 }
	} 
...
''Response.write "Audio Bit Depth"
...
'*******************************************************************************************************
		sql="SELECT AudioBitDepthID,AudioBitDepth FROM optAudioBitDepth ORDER BY AudioBitDepth"
'*******************************************************************************************************
...
<table id="tblForm" width=100%>
	<tr>
		<td>
			...
			<form method="post" name="frmAudioBitDepth" action="procInsertAudioBitDepth.asp">
				<tr>
					<td>
						Audio Bit Depth:</td>
					<td>				
						<input type="text" id="txtAudioBitDepth" name="txtAudioBitDepth" size="50">
					</td>
				</tr>
				<tr>
					<td>&nbsp</td>
				...
				<tr>
					<td align="Center" colspan="6">
						<input type="button" name="subUpdate" value="Add Audio Bit Depth" onclick="javascript:IsUnsignedIntegerBeforeSubmit();"></td>
				</tr>
				</form>
			</table>
		</td>
		<td>
			<table align=center id="tblTapeFormat" border=0 width=200 cellpadding=0 cellspacing=0>
						<tr bgcolor=#999900>
							<td align="center">Audio Bit Depth</td>
						</tr>
				<%sBGColor = "trBeige"%>
				...
				<%		do while not rsFrm.EOF %>
							<tr class=<%=sBGColor%> onmouseover="this.className='trWhite'" onmouseout="this.className='<%=sBGColor%>'" onclick="javascript:OpenEditFrm('frmUpdateAudioBitDepth.asp?AudioBitDepthID=<%=rsFrm.Fields("AudioBitDepthID")%>');">
								<td align="center"><%=rsFrm.Fields("AudioBitDepth")%></td>
							</tr>
				<%			rsFrm.MoveNext
