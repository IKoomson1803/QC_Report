...
'*******************************************************************************************************
		sql="SELECT VideoCodecID,VideoCodec FROM optVideoCodec ORDER BY VideoCodec"
'*******************************************************************************************************
...
<table id="tblForm" width=100%>
	<tr>
		<td>
			...
			<form method="post" name="frmVideoCodec" action="procInsertVideoCodec.asp">
				<tr>
					<td>
						Video Codec:</td>
					<td>				
						<input type="text" id="txtVideoCodec" name="txtVideoCodec" size="50">
					</td>
				</tr>
				<tr>
					<td>&nbsp</td>
				...
				<tr>
					<td align="Center" colspan="6">
						<input type="submit" name="subUpdate" value="Add Video Codec" ></td>
				</tr>
				</form>
			</table>
		</td>
		<td>
			<table align=center id="tblTapeFormat" border=0 width=200 cellpadding=0 cellspacing=0>
				...
				<%		do while not rsFrm.EOF %>
							<tr class=<%=sBGColor%> onmouseover="this.className='trWhite'" onmouseout="this.className='<%=sBGColor%>'" onclick="javascript:OpenEditFrm('frmUpdateVideoCodec.asp?VideoCodecID=<%=rsFrm.Fields("VideoCodecID")%>');">
								<td align="center"><%=rsFrm.Fields("VideoCodec")%></td>
							</tr>
				<%			rsFrm.MoveNext
