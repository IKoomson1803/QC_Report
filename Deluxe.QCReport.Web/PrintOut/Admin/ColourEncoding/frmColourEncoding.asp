...
'********************
dim rsFrm, rsCombo
dim sVideoDescID, sColourEncoding
dim sql
...
'*******************************************************************************************************
		sql="SELECT ColourEncodingID,ColourEncoding FROM optColourEncoding ORDER BY ColourEncoding"
'*******************************************************************************************************
...
<table id="tblForm" width=100%>
	<tr>
		<td>
			...
			<form method="post" name="frmColourEncoding" action="procInsertColourEncoding.asp">
				<tr>
					<td>
						Colour Encoding:</td>
					<td>				
						<input type="text" id="txtColourEncoding" name="txtColourEncoding" size="50">
					</td>
				</tr>
				<tr>
					<td>&nbsp</td>
				...
				<tr>
					<td align="Center" colspan="6">
						<input type="submit" name="subUpdate" value="Add Colour Encoding" ></td>
				</tr>
				</form>
			</table>
		</td>
		<td>
			<table align=center id="tblTapeFormat" border=0 width=200 cellpadding=0 cellspacing=0>
						<tr bgcolor=#999900>
							<td align="center">Colour Encoding</td>
						</tr>
				<%sBGColor = "trBeige"%>
				...
				<%		do while not rsFrm.EOF %>
							<tr class=<%=sBGColor%> onmouseover="this.className='trWhite'" onmouseout="this.className='<%=sBGColor%>'" onclick="javascript:OpenEditFrm('frmUpdateColourEncoding.asp?ColourEncodingID=<%=rsFrm.Fields("ColourEncodingID")%>');">
								<td align="center"><%=rsFrm.Fields("ColourEncoding")%></td>
							</tr>
				<%			rsFrm.MoveNext
