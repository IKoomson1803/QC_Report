ALTER TABLE [bward].[qcHeader] ALTER COLUMN [Epis_no] NVARCHAR(255) NULL
ALTER TABLE [bward].[qcHeader] ALTER COLUMN [Show] NVARCHAR(255) NULL
ALTER TABLE [bward].[qcHeader] ALTER COLUMN [Epis_Name] NVARCHAR(255) NULL

GO

GO
/****** Object:  StoredProcedure [bward].[sp_UpdateHeaderDetails]    Script Date: 08/02/2022 10:31:20 ******/
SET ANSI_NULLS ON
GO
