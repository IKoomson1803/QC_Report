--ALTER TABLE [bward].[qcHeader] ALTER COLUMN [ProductPlacementLogoPresentAndInSafeArea] VARCHAR(5) NULL
--ALTER TABLE [bward].[qcHeader] ALTER COLUMN [SponsorshipHeadAndTailPresent] VARCHAR(5) NULL
--ALTER TABLE [bward].[qcHeader] ALTER COLUMN [TAndCsWithinSafeArea] VARCHAR(5) NULL

--GO


--ALTER PROCEDURE [bward].[up_UpdateDPPCommBroadcasters]
--	@QCNum INT,
--	@SubQCNum INT,
--	@ProductPlacementLogoPresentAndInSafeArea VARCHAR(5) = NULL,
--	@SponsorshipHeadAndTailPresent VARCHAR(5) = NULL,
--	@TAndCsWithinSafeArea VARCHAR(5) = NULL
