--ALTER TABLE [bward].[qcTime] ADD QC_Codename VARCHAR(20) NULL
--GO


/****** Object:  StoredProcedure [bward].[sp_SelectLog]    Script Date: 20/01/2022 14:18:49 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [bward].[sp_AddLog]    Script Date: 20/01/2022 14:37:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	INSERT INTO 
		...
		(QCNum, subQCNum, Time_code, QC_Code, Note, QC_Grade, [Action], item_Duratn, in_Master, item_num, ActionsForDisplay, QC_Codename)
	
	VALUES
		(@_QCNum, @_rev, @_tc, @_qcCode, @_note, @_qcGrade, @_action, @_duration, @_inMaster, @_itemNum, @_actionsForDisplay, @_qcCodename)
...
/****** Object:  StoredProcedure [bward].[sp_UpdateLog]    Script Date: 20/01/2022 14:41:42 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
