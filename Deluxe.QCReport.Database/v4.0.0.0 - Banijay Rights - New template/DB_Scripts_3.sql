...
ALTER TABLE [bward].[qcHeader] ADD ColourSpace VARCHAR(50) NULL
...
/****** Object:  StoredProcedure [bward].[sp_SelectOverallSpecs]    Script Date: 24/03/2023 15:43:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	SELECT	
			...
			DecodeCheck, MaxCLL, MaxFALL, ColourSpace
	FROM 
			[bward].qcHeader
	WHERE 
...
/****** Object:  StoredProcedure [bward].[sp_UpdateOverallSpecs]    Script Date: 24/03/2023 15:44:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [QCSUK]
GO
/****** Object:  StoredProcedure [bward].[sp_CopyQCReport]    Script Date: 24/03/2023 15:48:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
