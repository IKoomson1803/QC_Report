...
ALTER TABLE [bward].[qcHeader] ADD QCActionType VARCHAR(50) NULL
ALTER TABLE [bward].[qcHeader] ADD QCVendor VARCHAR(150) NULL
...
/****** Object:  StoredProcedure [bward].[ins_up_InsertOrUpdateBanijayRightsTextDetails]    Script Date: 27/02/2023 11:56:00 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [bward].[sp_CopyQCReport]    Script Date: 27/02/2023 10:24:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [bward].[up_UpdateBanijayRightsProgrammeDetails]    Script Date: 27/02/2023 10:35:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [bward].[sp_CopyQCReport]    Script Date: 28/02/2023 13:00:56 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
